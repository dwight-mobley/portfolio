  ...
  return (
    <section id="skills" className="py-24 bg-zinc-50">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-zinc-900">Technical Skills</h2>
            ...
            <div key={category.label}>
              ...
              <div className="flex flex-wrap gap-4">
                {category.items.map((skill) => (
                  <div
                    key={skill.name}
                    className="flex flex-col items-center gap-2 bg-white rounded-xl p-4 shadow-sm w-24 text-center"
                  >
                    {skill.iconUrl ? (
                      <Image
                        src={skill.iconUrl}
